# 💫 Fitness Tracker Managemnet System -COREO:
<br><br>This is a Diet and Fitness Tracking System built with React (Frontend) and Node.js (Backend).<br> The project enables users to track their diet and fitness routines. It includes video-based progress unlocking, where users can unlock videos sequentially by completing their tasks. The system stores videos in Base64 format in MongoDB and supports 7-day challenge systems.
